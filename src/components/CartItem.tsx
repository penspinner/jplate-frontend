...
const CartItem = (props: {
  ...
  return (
    <div className="hover:bg-gray-200 rounded-lg pt-5 pb-5 w-full flex flex-col md:grid md:grid-flow-row md:grid-cols-3 md:gap-5 md:pr-5 md:pl-5 md:pb-5 md:pt-5 md:justify-center md:items-center">
      <span>
